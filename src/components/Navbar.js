...
function Navbar({ title, theme, toggleTheme }) {
                ...
                <div className="container-fluid">
                    ...
                    <div className="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <div className="form-check form-switch">
                            ...
                            <label className={`form-check-label text-${theme === "light" ? "black" : "white"}`} htmlFor="flexSwitchCheckDefault">Enable dark mode</label>
                        </div>
